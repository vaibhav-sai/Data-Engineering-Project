...
raw_data_path = f"/Volumes/ecommerce/raw/ecomm_data/brands/brands.csv"

df=spark.read.format('csv').option('header', "true").option("delimeter", ",").load(raw_data_path)
...
raw_data_path = f"/Volumes/ecommerce/raw/ecomm_data/category/category.csv" 
...
# Load data using the schema defined
raw_data_path = f"/Volumes/ecommerce/raw/ecomm_data/products/products.csv"
...
# Load data using the schema defined
raw_data_path = f"/Volumes/ecommerce/raw/ecomm_data/customers/customers.csv" 
...
# Load data using the schema defined
raw_data_path = f"/Volumes/ecommerce/raw/ecomm_data/date/date.csv"
